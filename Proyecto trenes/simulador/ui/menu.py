...
from ui.mostrar_datos import mostrar_datos_tren
...
def emergencia():
    print("Evento climático precaucion.")
...
def ventana_crear_opciones():
    ...
    tk.Button(ventanafaz, text="Mostrar datos", command = lambda: mostrar_datos_tren(ventanafaz)).place(x=20, y=260)